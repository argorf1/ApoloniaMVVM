...
{
    class CreateCommand<TViewModel,TModel> : CommandBase
        ...
        where TModel : EntityModelBase
    {
        ...
        public CreateCommand(Func<bool> createModel, Func<TViewModel> viewModel, FrameStore frameStore, Func<bool> checkModel, TModel model)
        {
